...
permalink: /
title: "John Kopper"
description: "John Kopper is a machine learning and AI practitioner and former research mathematician."
redirect_from:
  - /about/
  - /about.html
---
...
<section class="section about-grid" aria-label="Background">
  <article>
    ...
    <p>I build practical systems with data, models, and software engineering discipline.</p>
  </article>
  <article>
    <p class="eyebrow">Research</p>
    <h2>Algebraic geometry</h2>
    <p>My academic work focused on vector bundles, moduli spaces, Hilbert schemes, and effective cones.</p>
  </article>
  <article>
